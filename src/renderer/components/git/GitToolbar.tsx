...
function ToolbarButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      title={label}
      className="flex items-center gap-1 px-2 py-[3px] text-[12px] text-mac-label-secondary hover:text-mac-label hover:bg-mac-control-active active:bg-mac-separator rounded transition-colors disabled:opacity-25 disabled:pointer-events-none"
    >
      {children}
      <span>{label}</span>
    </button>
...
export default function GitToolbar() {
  ...
  return (
    <div className="h-[32px] border-b border-mac-separator-heavy bg-mac-bg-toolbar flex items-center px-1.5 gap-px shrink-0">
      ...
      <div className="w-px h-3.5 bg-mac-separator-heavy mx-1" />
